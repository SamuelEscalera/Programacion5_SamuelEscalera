...
generateBlockHTML (MdBackgroundColor color) = "<style>\n body {\n background-color: #" ++ color ++ ";\n }\n </style>\n" 
generateBlockHTML (MdBackGroundImg img) = "<style>\n body {\n background-image: url(" ++ img ++ ");\n background-size: cover; \n}\n </style>\n" 
generateBlockHTML (MdProgress value) = "<div><progress value=" ++ value ++ " max=100></progress></div>\n"
generateBlockHTML (MdImg url) = "<div><img src=" ++ url ++ "></div>\n"
generateBlockHTML (MdYoutubeVideo youtubeUrl) = "<iframe width=560 height=315 src=" ++ youtubeUrl ++ "title=YouTube video player frameborder=0 allow=accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share referrerpolicy=strict-origin-when-cross-origin allowfullscreen></iframe>"